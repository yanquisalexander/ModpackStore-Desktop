    ...
    <v-container fill-height fluid>
      <v-row align="center" justify="center">
        <v-col>
          <v-card
            elevation="1"
            class="mx-auto loginCard text-center"
            color="#333333"
            max-width="380"
          >
            <v-img
              src="https://store-images.s-microsoft.com/image/apps.2678.14513124030084310.ec67955a-94fe-46fe-943b-1c6afb546be2.4e30ef5c-a49b-4b04-867c-a953936bf086"
            ></v-img>
            <h1 class="login-title pt-6 pb-2">Modpack Store</h1>
            <p class="login-subtitle pb-4">
              Inicia sesión para acceder a Modpack Store
            </p>
